...
For magnetic materials (nspin=2), the package:
    ...
    Detects spin polarization from XML (<lsda>true</lsda>)
    Separates eigenvalues into spin-up and spin-down channels
    Adjusts electron count: nelec_adjusted = nelec - nbnd_exclude
    Generates separate .bandsdat files for each spin channel
...
Reference: X. Ma et al., "Ab initio calculation of thermoelectric properties in 3d ferromagnets", New Journal of Physics (2023). DOI: 10.1088/1367-2630/accca1
Dependencies
